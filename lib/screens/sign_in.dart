        ...
        body: SingleChildScrollView(
          ...
          child: Container(
            margin: EdgeInsets.symmetric(
                vertical: sizee.height / 10, horizontal: sizee.width / 20),
            child: Column(children: [
              Container(
                padding: EdgeInsets.only(
                  bottom: sizee.height / 40,
                ),
                child: Row(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                        margin:
                            EdgeInsets.symmetric(vertical: sizee.height / 70),
              ...
              Container(
                margin: EdgeInsets.only(
                    left: sizee.width / 4.2, top: sizee.height / 80),
                child: Row(
                  children: [
                    Image(
                      image: AssetImage('assets/images/ligne.png'),
                      width: sizee.width / 6.2,
                    ),
                    Padding(
                  ...
                  children: [
                    Container(
                        ...
                        child: Image(
                          ...
                          width: sizee.width / 7,
                          height: sizee.width / 7,
                        )),
                    Image(
                      image: AssetImage('assets/images/fb.png'),
                      width: sizee.width / 6.5,
                      height: sizee.width / 6.5,
                    )
                  ],
                ),
              ),
